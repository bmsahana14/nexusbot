...
During the deployment process, Vercel will ask for these values. Copy and paste them from below:
...
1. Copy your new Vercel URL (e.g., `https://nexusbot.vercel.app`).
2. If you want to use the **Admin Dashboard**, navigate to `/admin` to sync your knowledge base.
3. To embed the bot on other sites, see [EMBEDDING.md](./EMBEDDING.md).
